...
class UniformSurfaceSampler:
    ...
    def __next__(self):
        ...
        face = indexing.batch_indexing(self.vf, f_idx, dim=-3) # [*B, 1, 3, 3]
        ...
        point = indexing.multibatch_mm(w[...,None,:], face).squeeze(-2)
    ...
    def get(self, count):
        ...
        face = indexing.batch_indexing(self.vf, f_idx, dim=-3) # [*B, k, 3, 3]
